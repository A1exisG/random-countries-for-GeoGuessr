      ...
      fetch(proxyUrl)
         ...
         .then((data) => {
            ...
            resultMap.innerHTML = `                        
               ...
               <div>
                  <span class="name">${randomMap.name} <a href="https://www.geoguessr.com/maps${randomMap.url}" target="_blank"><img src="./img/ext-link-icon.svg" alt="External Link Icon"/> </a></span>
